...
Open Source components for reactive apps
...
1. A clone of the [repo](https://github.com/appbaseio/rx-docs) on your local machine
1. A fork of the repo (for any contributions)

### Installation

1. `cd rx-docs` to go into the project root
...
1. `git checkout master` from any folder in your local `rx-docs` repository
...
1. Go to the [repo](https://github.com/appbaseio/rx-docs) and you should see recently pushed branches.
